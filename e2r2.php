        ...
        if($member1&&$member2)
        {
            ...
            if($numRow1 == 1)
            {
                if($numRow2 == 1)
                {
                    ...
                    if($userRowData2)
                    {
                        echo "<script>alert('$member1 or $member2 has already participated in event 2');</script>" . "<a href='index.php'>Back to home</a>";;
                    }
                    else
                    {
                        // if($userRowData2)
                        // {
                            //m2 already participated
